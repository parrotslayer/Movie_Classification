...
%temp = cropped_face_resized;
%clear cropped_face_resized
%cropped_face_resized = temp(:,1:100);
...
% um=100;
% ustd=80;
% load('Egien_Face_Workspace_100.mat', 'u');
% load('Egien_Face_Workspace_100.mat', 'irow');
% load('Egien_Face_Workspace_100.mat', 'icol');
% load('Egien_Face_Workspace_100.mat', 'temp');
% load('Egien_Face_Workspace_100.mat', 'm');
% load('Egien_Face_Workspace_100.mat', 'M');
% load('Egien_Face_Workspace_100.mat', 'omega');
